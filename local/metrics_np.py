...
def compute_metrics(total_losses, all_score_predictions, all_score_targets, bins=None, lv_intv=0.5):
    ...
    total_losses['within_0.5'] = _accuracy_within_margin(all_score_predictions, all_score_targets, lv_intv)
    total_losses['within_1.0'] = _accuracy_within_margin(all_score_predictions, all_score_targets, lv_intv * 2)
    total_losses['mcwithin_0.5'] = compute_within_acc(all_score_predictions, all_score_targets, lv_intv)
    total_losses['mcwithin_1.0'] = compute_within_acc(all_score_predictions, all_score_targets, lv_intv * 2)
